# У Гитхаба есть публичное апи, позволяющее взаимодействовать с его функциями. Автор кода написал тесты на работу с функционалом Пулл реквеста
# Нужно провести ревью автотестов.
